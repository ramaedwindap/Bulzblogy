        ...
        <div className="border shadow-sm rounded-lg overflow-hidden">
            ...
            <div className="px-4 py-4">
                <div className="mb-1">
                    ...
                    <Link href={route("articles.show", article.slug)}>
                        <h1 className="text-gray-800 md:line-clamp-1 line-clamp-1 font-semibold tracking-tight">
                            {article.title}
                        </h1>
                        <div className="hidden md:block">
                            <p className="text-gray-500 mt-2 line-clamp-1 tracking-tighter">
                                {article.teaser}
                            </p>
                        </div>
                    </Link>

                    <small className="block mt-2 text-xs text-gray-500 md:mt-4">
